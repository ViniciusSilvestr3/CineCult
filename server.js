    ...
    'terror': {
        ...
        playlist: [
            { 
                ...
                poster: 'https://archive.org/services/img/dr..-jekyll.-and.-mr..-hyde.-1931',
                duracao: 5880
            },
            { 
            ...
            },
            {
                ...
                poster: 'https://archive.org/services/img/silent-die-nibelungen-siegfried',
                duracao: 7200
            }
        ]
    }
...
io.on('connection', (socket) => {
    ...
    socket.on('enviar_mensagem', (dados) => {
        io.to(dados.sala).emit('nova_mensagem', dados);
    });
});
